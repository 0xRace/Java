...
{
    // You don't have to add or change this main method.
	public static void main( String args[] )
	{
        ...
        /* 
           Note that the methods in the ArrayFunHouseTwo class are static, meaning
           that they are invoked by the name of the class, and not by the name of an object.
        */
        
		System.out.println(ArrayFunHouseTwo.toString(one));
		System.out.println("is going Up ?  " + ArrayFunHouseTwo.goingUp(one));
		System.out.println(ArrayFunHouseTwo.toString(two));
		System.out.println("is going Up ?  " + ArrayFunHouseTwo.goingUp(two));
		System.out.println(ArrayFunHouseTwo.toString(three));
		System.out.println("is going Up ?  " + ArrayFunHouseTwo.goingUp(three));
		System.out.println(ArrayFunHouseTwo.toString(four));
		System.out.println("is going Up ?  " + ArrayFunHouseTwo.goingUp(four));

		System.out.println("\n\n"+ArrayFunHouseTwo.toString(one));
		...
		System.out.println("first 7 values greater than 9  " + ArrayFunHouseTwo.toString(updated));
		updated = ArrayFunHouseTwo.getCountValuesBiggerThanX(four, 5, 15);
		System.out.println("first 5 values greater than 15  " + ArrayFunHouseTwo.toString(updated));
	}
}