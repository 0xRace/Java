...
import setsAndMaps.Bag;
import setsAndMaps.CourseList;
...
public class PublicTests {
  ...
  // Tests calling contains() on elements that are in a bag and one one that
  // is not.
  ...
  @Test public void testPublic14() {
    ...
    assertFalse(courseList.isTakingCourse("Penny Penguin", "CMSC 321"));
  }
  ...
  @Test public void testPublic15() {
    ...
    assertTrue(courseList.isTakingCourse("Kourtney Koala", "CMSC 567"));
    assertTrue(courseList.isTakingCourse("Kourtney Koala", "CMSC 799"));
    assertTrue(courseList.isTakingCourse("Kourtney Koala", "MATH 345"));

    assertTrue(courseList.isTakingCourse("Penny Penguin", "CMSC 456"));
    assertTrue(courseList.isTakingCourse("Penny Penguin", "CMSC 567"));
    assertTrue(courseList.isTakingCourse("Penny Penguin", "CMSC 799"));
    assertTrue(courseList.isTakingCourse("Penny Penguin", "CMSC 899"));
  }
  ...
  @Test public void testPublic16() {
    ...
    assertFalse(courseList.isTakingCourse("Kourtney Koala", "CMSC 456"));
    assertFalse(courseList.isTakingCourse("Kourtney Koala", "CMSC 700"));
    assertFalse(courseList.isTakingCourse("Kourtney Koala", "CMSC 800"));
    assertFalse(courseList.isTakingCourse("Kourtney Koala", "CMSC 899"));

    assertFalse(courseList.isTakingCourse("Penny Penguin", "CMSC 700"));
    assertFalse(courseList.isTakingCourse("Penny Penguin", "CMSC 800"));
    assertFalse(courseList.isTakingCourse("Penny Penguin", "MATH 899"));
    assertFalse(courseList.isTakingCourse("Penny Penguin", "MATH 345"));
  }
  ...
  @Test public void testPublic18() {
    ...
    assertEquals(3, courseList.numCoursesTaking("Kourtney Koala"));
    assertEquals(4, courseList.numCoursesTaking("Penny Penguin"));
  }
  ...
  // which the student signs up for a new course.
  ...
  @Test public void testPublic27() {
    ...
    courseList.dropCourse("Penny Penguin", "CMSC 567");
  ...
  public CourseList exampleCourseList() {
    ...
    courseList.takeCourse("Penny Penguin", "CMSC 456");
    courseList.takeCourse("Kourtney Koala", "MATH 345");
    courseList.takeCourse("Kourtney Koala", "CMSC 567");
    courseList.takeCourse("Ginny Giraffe", "CMSC 456");
    courseList.takeCourse("Armand Armadillo", "CMSC 567");
    courseList.takeCourse("Penny Penguin", "CMSC 567");
    ...
    courseList.takeCourse("Penny Penguin", "CMSC 799");
    courseList.takeCourse("Kourtney Koala", "CMSC 799");
    courseList.takeCourse("Penny Penguin", "CMSC 899");
